...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-BQS5GV0\\SQLEXPRESS;Database=persona_db;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => new { e.IdProf, e.CcPer }).HasName("PK__estudios__FB3F71A618890CFB");
        ...
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666D26DE3864");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83FEB71C5EE");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D659C8CB6F9");
            ...
            entity.HasOne(d => d.DuenioNavigation).WithMany(p => p.Telefonos)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__telefono__duenio__300424B4");
        });
